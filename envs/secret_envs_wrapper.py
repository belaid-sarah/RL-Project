...
# Chemin relatif au fichier secret_envs_wrapper.py
_wrapper_dir = Path(__file__).parent.absolute()

if platform.system().lower() == "windows":
    lib_path = str(_wrapper_dir / "libs" / "secret_envs.dll")
elif platform.system().lower() == "linux":
    lib_path = str(_wrapper_dir / "libs" / "libsecret_envs.so")
elif platform.system().lower() == "darwin":
    if "intel" in platform.processor().lower():
        lib_path = str(_wrapper_dir / "libs" / "libsecret_envs_intel_macos.dylib")
    else:
        lib_path = str(_wrapper_dir / "libs" / "libsecret_envs.dylib")
